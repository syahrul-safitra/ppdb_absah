                ...
                <div class="col-lg-6 border rounded">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('NIK') 'is-invalid' @enderror" name="NIK"
                            id="nik" placeholder="NIK" minlength="16" value="{{ @old('NIK') }}">
                        @error('NIK')
                            <div class="invalid-feedback d-block">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('No_KK') 'is-invalid' @enderror" name="No_KK"
                            id="no_kk" placeholder="No KK" minlength="16" value="{{ @old('No_KK') }}">
                        @error('No_KK')
                            <div class="invalid-feedback d-block">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        <div class="input-group">
                            ...
                            <input type="number" name="anak_ke"
                                ...
                                value="{{ @old('anak_ke') }}" placeholder="Anak Ke">
                        </div>
                        @error('anak_ke')
                            <div class="invalid-feedback d-block">
                                {{ $message }}
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="cita_cita"
                            ...
                            placeholder="Cita-Cita" value="{{ @old('cita_cita') }}">
                        @error('cita_cita')
                            <div class="invalid-feedback d-block">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" name="pas_foto" type="file" id="formFile" required>
                        @error('pas_foto')
                            <div class="invalid-feedback d-block">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" name="file_kk" type="file" id="formFile" required>
                        @error('file_kk')
                            <div class="invalid-feedback d-block">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" name="file_akta" type="file" id="formFile" required>
                        @error('file_akta')
                            <div class="invalid-feedback d-block">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('NPSN') 'is-invalid' @enderror"
                            name="NPSN" id="NPSN" placeholder="NPSN" value="{{ @old('NPSN') }}">
                        @error('NPSN')
                            <div class="invalid-feedback d-block">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" name="status_sekolah" id="status_sekolah">
                            @if (@old('status_sekolah'))
                                @foreach ($dataStatusSekolah as $data)
                                    @if ($data == @old('status_sekolah'))
                                        <option value="{{ $data }}" selected>{{ $data }}</option>
                                    @else
                                        <option value="{{ $data }}">{{ $data }}</option>
                                    @endif
                    ...
                    <div class="mb-3">
                        ...
                        <select class="js-example-basic-single" style="width: 100%" name="kecamatan_sekolah"
                            ...
                            @if (@old('kecamatan_sekolah'))
                                <option value="{{ @old('kecamatan_sekolah') }}" selected>
                                    {{ @old('kecamatan_sekolah') }}</option>
                            @else
                                <option value="">--Pilih--</option>
                            @endif
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('no_peserta_ujian') 'is-invalid' @enderror"
                            name="no_peserta_ujian" id="no_peserta_ujian" value="{{ @old('no_peserta_ujian') }}"
                ...
                <div class="col-lg-6 border rounded">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" name="penghasilan_org_tua" id="penghasilan_org_tua">
                            <option value="">--Pilih--</option>
                            @if (old('penghasilan_org_tua'))
                                @foreach ($dataPenghasilan as $penghasilan)
                                    @if (old('penghasilan_org_tua') == $penghasilan)
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" name="pekerjaan_ayah" id="pekerjaan_ayah">
                            ...
                            @if (@old('pekerjaan_ayah'))
                                @foreach ($dataPekerjaan as $data)
                                    @if ($data == @old('pekerjaan_ayah'))
                                        <option value="{{ $data }}" selected>{{ $data }}</option>
                                    @else
                                        <option value="{{ $data }}">{{ $data }}</option>
                                    @endif
                    ...
                    <div class="mb-3">
                        ...
                        <select class="" style="width: 100%" name="kecamatan_ayah" id="kecamatan_ayah">
                            @if (@old('kecamatan_ayah'))
                                <option value="{{ @old('kecamatan_ayah') }}">{{ @old('kecamatan_ayah') }}</option>
                            @else
                                <option value="">--Pilih--</option>
                            @endif
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('alamat_ayah') 'is-invalid' @enderror"
                            name="alamat_ayah" id="alamat_ayah" value="{{ @old('alamat_ayah') }}"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('no_wa_ayah') 'is-invalid' @enderror"
                            name="no_wa_ayah" id="no_wa_ayah" value="{{ @old('no_wa_ayah') }}"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('nama_ibu') 'is-invalid' @enderror"
                            name="nama_ibu" id="nama_ibu" placeholder="Nama Ibu" value="{{ @old('nama_ibu') }}">
                        @error('nama_ibu')
                            <div class="invalid-feedback d-block">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="js-example-basic-single" style="width: 100%" name="kecamatan_ibu"
                            id="kecamatan_ibu">
                            @if (old('kecamatan_ibu'))
                                <option value="{{ @old('kecamatan_ibu') }}" selected>{{ @old('kecamatan_ibu') }}
                                </option>
                            @else
                                <option value="">--Pilih--</option>
                            @endif
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('no_hp_ibu') 'is-invalid' @enderror"
                            name="no_hp_ibu" id="no_hp_ibu" value="{{ @old('no_hp_ibu') }}"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('no_kk_wali') is-invalid @enderror"
                            name="nik_wali" id="no_kk_wali" value="{{ @old('no_kk_wali') }}"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('tempat_lahir_wali') is-invalid @enderror"
                            name="tempat_lahir_wali" id="no_kk_wali" value="{{ @old('tempat_lahir_wali') }}"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control @error('tanggal_lahir_wali') is-invalid @enderror"
                            ...
                            value="{{ @old('tanggal_lahir_wali') }}" placeholder="Tanggal Lahir Wali">
                        @error('tempat_lahir_wali')
                            <div class="invalid-feedback d-block">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" name="pekerjaan_wali" id="pekerjaan_wali">
                            @if (@old('pekerjaan_wali'))
                                @foreach ($dataPekerjaan as $data)
                                    @if ($data == @old('pekerjaan_wali'))
                                        <option value="{{ old('pekerjaan_wali') }}" selected>
                                            {{ old('pekerjaan_wali') }}</option>
                                    @else
                                        <option value="{{ $data }}">{{ $data }}</option>
                                    @endif
                                @endforeach
                    ...
                    <div class="mb-3">
                        ...
                        <select class="js-example-basic-single" style="width: 100%" name="kecamatan_wali"
                            id="kecamatan_wali">
                            @if (@old('kecamatan_wali'))
                                <option value="{{ @old('kecamatan_wali') }}">{{ @old('kecamatan_wali') }}</option>
                            @else
                                <option value="">--Pilih--</option>
                            @endif
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('alamat_wali') 'is-invalid' @enderror"
                            name="alamat_wali" id="alamat_wali" value="{{ @old('alamat_wali') }}"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('no_hp_wali') 'is-invalid' @enderror"
                            name="no_hp_wali" id="no_hp_wali" value="{{ @old('no_hp_wali') }}"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('no_wa_wali') 'is-invalid' @enderror"
                            name="no_wa_wali" id="no_wa_wali" value="{{ @old('no_wa_wali') }}"
                            placeholder="No Wa Wali">
                        @error('no_wa_wali')
                            <div class="invalid-feedback d-block">
                                {{ $message }}
